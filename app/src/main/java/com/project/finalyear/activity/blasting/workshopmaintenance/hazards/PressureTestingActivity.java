...
import com.project.finalyear.activity.blasting.workshopmaintenance.controlmeasure.PressureTestingMeasureActivity;
...
public class PressureTestingActivity extends AppCompatActivity {
    ...
    public void controlMeasure() {
        Intent intent = new Intent(getApplicationContext(), PressureTestingMeasureActivity.class);
