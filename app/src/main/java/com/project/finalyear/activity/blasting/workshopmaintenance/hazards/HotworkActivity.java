...
import com.project.finalyear.activity.blasting.workshopmaintenance.controlmeasure.HotworkMeasureActivity;
...
public class HotworkActivity extends AppCompatActivity {
    ...
    public void controlMeasure() {
        Intent intent = new Intent(getApplicationContext(), HotworkMeasureActivity.class);
