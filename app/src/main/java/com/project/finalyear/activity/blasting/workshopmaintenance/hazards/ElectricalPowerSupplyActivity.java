...
import com.project.finalyear.activity.blasting.workshopmaintenance.controlmeasure.ElectricalSupplyMeasureActivity;
...
public class ElectricalPowerSupplyActivity extends AppCompatActivity {
    ...
    public void controlMeasure() {
        Intent intent = new Intent(getApplicationContext(), ElectricalSupplyMeasureActivity.class);
