package com.project.finalyear.activity.blasting.forklift.controlmeasure;
...
public class PuttingDownMeasureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_putting_down_measure);
