package com.project.finalyear.activity.painting.touchup.controlmeasure;
...
public class CleanUpPaintMeasureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clean_up_paint_measure);
