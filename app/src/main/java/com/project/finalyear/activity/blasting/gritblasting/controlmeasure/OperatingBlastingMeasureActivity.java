package com.project.finalyear.activity.blasting.gritblasting.controlmeasure;
...
public class OperatingBlastingMeasureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_operating_blasting_measure);
    ...
    @OnClick(R.id.button)
    public void backToGritBlasting() {
