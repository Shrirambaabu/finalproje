...
import com.project.finalyear.activity.blasting.workshopmaintenance.controlmeasure.AssembleMeasureActivity;
...
public class AssembleActivity extends AppCompatActivity {
    ...
    public void controlMeasure() {
        Intent intent = new Intent(getApplicationContext(), AssembleMeasureActivity.class);
