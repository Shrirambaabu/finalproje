package com.project.finalyear.activity.painting.powertooling.controlmeasure;
...
public class DemobiliseMeasureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demobilise_measure);
    ...
    @OnClick(R.id.button)
    public void backToPowerTooling() {
