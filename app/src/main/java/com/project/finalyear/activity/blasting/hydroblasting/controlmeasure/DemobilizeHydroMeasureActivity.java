package com.project.finalyear.activity.blasting.hydroblasting.controlmeasure;
...
public class DemobilizeHydroMeasureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demobilize_hydro_measure);
    ...
    @OnClick(R.id.button)
    public void backToHydroBlasting() {
